...
from .....types.mailbox.stream import registry_retrieve_params
from .....types.mailbox.stream.registry import PaginatedStreamRegistry
...
class Registry(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Get all Registry Items in this stream
        ...
        """
        return self._get(
            f"/mailbox/{id}/stream/{slug}/registry",
