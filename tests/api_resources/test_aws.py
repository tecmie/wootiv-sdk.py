...
from tecmie.types import AwsS3GetSignedURLResponse
...
class TestAws:
    ...
    @parametrize
    def test_method_create_signed_put_url(self, client: Tecmie) -> None:
...
class TestAsyncAws:
    ...
    @parametrize
    async def test_method_create_signed_put_url(self, client: AsyncTecmie) -> None:
